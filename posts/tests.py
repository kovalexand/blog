...
class CategoryTestClass(ApplicationTestBaseClass):
    def test_retrieve_post_method(self):
        ...
        url = reverse(viewname='post-detail', kwargs=kwargs)
    ...
    def test_category_list_post_method(self):
        ...
        url = reverse(viewname='category-post-list', kwargs=kwargs)
        response = self.client.get(url)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_category_retrieve_post_method(self):
        ...
        url = reverse(viewname='category-post-detail', kwargs=kwargs)
        response = self.client.get(url)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_user_list_post_method(self):
        ...
        url = reverse(viewname='user-post-list', kwargs=kwargs)
        response = self.client.get(url)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_user_retrieve_post_method(self):
        ...
        url = reverse(viewname='user-post-detail', kwargs=kwargs)
        response = self.client.get(url)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_user_category_list_post_method(self):
        ...
        url = reverse(viewname='user-category-post-list', kwargs=kwargs)
        response = self.client.get(url)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_user_category_retrieve_post_method(self):
        ...
        url = reverse(viewname='user-category-post-detail', kwargs=kwargs)
        response = self.client.get(url)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
